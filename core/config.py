...
# Multiplayer Mechanics Settings
SWAP_WARMUP = 1.5
CONFUSION_DURATION = 3.0
MINI_BH_RADIUS = 10
MINI_BH_LIFETIME = 4.0
MINI_BH_INFLUENCE_RADIUS = 180
...
P2_COLOR = (0, 255, 127)      # Spring Green
ASTEROID_COLOR = (180, 180, 190)
BULLET_COLOR = (255, 255, 100)
CONFUSION_COLOR = (255, 105, 180) # Hot Pink
GRAVITY_BOMB_COLOR = (147, 112, 219) # Purple
WHITE = (240, 240, 240)
BLACK = (0, 0, 0)
